...
ut.plot_reward_and_action(rewards, actions, None,
                          image_folder, f'bandits_{delay}_delayed_{T}_mu_{mu:.2f}_a0_{a_0:.2f}.png',
...
# Save results
with open(os.path.join(results_folder, f'bandits_{delay}_delayed_{T}_mu_{mu:.2f}_a0_{a_0:.2f}.txt'), 'w+') as f:
