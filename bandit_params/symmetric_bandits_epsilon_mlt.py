...
ut.plot_reward_and_action(rewards, actions, None,
                          image_folder, f'bandits_{delay}_delayed_{T}_eps_{epsilon}_mlt_{no_sim}.png',
...
data_folder = os.path.join(
    root_data_folder, f"data_bandits_{delay}_delayed_{T}_eps_{epsilon}_mlt_{no_sim}")
...
ut.reduce_results(all_rewards, all_actions, initial_T,
                  ...
                  results_folder, f"bandits_{delay}_delayed_{T}_eps_{epsilon}_mlt_{no_sim}.txt")
