...
# Create folder name
image_folder = '_images/no_agents'
results_folder = '_results/no_agents'
...
ut.plot_reward_and_action(rewards, actions, None,
                          image_folder, f'bandits_{delay}_delayed_{T}_no_agents_{N}_mlt_{no_sim}.png',
...
data_folder = os.path.join(
    results_folder, f"data_bandits_{delay}_delayed_{T}_no_agents_{N}_mlt_{no_sim}")
...
ut.reduce_results(all_rewards, all_actions, initial_T,
                  ...
                  results_folder, f"bandits_{delay}_delayed_{T}_no_agents_{N}_mlt_{no_sim}.txt")
