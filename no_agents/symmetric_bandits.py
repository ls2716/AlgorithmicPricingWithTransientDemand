...
ut.plot_reward_and_action(rewards, actions, None,
                          image_folder, f'bandits_{delay}_delayed_{T}_no_agents_{N}.png',
...
# Save results
with open(os.path.join(results_folder, f'bandits_{delay}_delayed_{T}_no_agents_{N}.txt'), 'w+') as f:
