...
ut.plot_reward_and_action(rewards, actions, None,
                          image_folder, f'bandits_{delay}_delayed_{T}_noise_{noise_level}.png',
...
# Save results
with open(os.path.join(results_folder, f'bandits_{delay}_delayed_{T}_noise_{noise_level}.txt'), 'w+') as f:
